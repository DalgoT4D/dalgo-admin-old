...
class Datasource(models.Model):
    ...
    client = models.ForeignKey(Client,on_delete= models.CASCADE,related_name='datasource')
...
class Pipelineconfig(models.Model):
    ...
    client = models.ForeignKey(Client,on_delete= models.CASCADE,related_name='pipelineconfig')
